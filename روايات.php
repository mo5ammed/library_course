...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <div class="content"> 
      <h2 style="text-align: center;">  كتب الروايات</h2>
    ...
    <?php
          ...
          $stmt = $con->prepare("SELECT book.*, categories.Cat_name AS cat_name FROM book INNER JOIN categories ON categories.Cat_id =book.cat_ID where statuss=1 and no_copies>0 and cat_name='روايات' ORDER BY id_book DESC ");      
