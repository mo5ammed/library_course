...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <div class="content"> 
      <h2 style="text-align: center;">قسم الكتب الانجليزية</h2>
    ...
    <?php
          ...
          INNER JOIN categories ON categories.Cat_id =book.cat_ID where lang_book='en' and statuss=1 and no_copies>0  ORDER BY id_book DESC ");      
